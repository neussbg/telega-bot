    ...
    return await  bot.sendMessage(chatId, `${msg}`, {
                    reply_markup:{
                        keyboard:[
                            [
                                {
                                    text: '👟Обувь/Верхняя одежда/Рюкзаки/Сумки'
                                },
                                {
                            ...
                            [
                                ...
                                {
                                    text: '🧦Носки/Нижнее белье/Акссесуары'
                                },
                            ],
                            [
                                {
...
определенный регион.☺️`)
        ...
        if(msg.text.includes('Обувь')){
            return setActualCursForClother(1,'👟Обувь/Верхняя одежда/Рюкзаки/Сумки', chatId, bot );
        }
        ...
        if(msg.text.includes('Носки')){
            return setActualCursForClother(4,'🧦Носки/Нижнее белье/Акссесуары', chatId, bot );
        }
